...
const checkWorkspaceAdmin = async (workspaceId: string, userId: string, prismaClient: typeof prisma) => {
...
const checkProjectAdmin = async (projectId: string, userId: string, prismaClient: typeof prisma) => {
