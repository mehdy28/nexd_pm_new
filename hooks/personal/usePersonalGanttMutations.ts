...
//       update(cache, { data }) {
//         const updatedTask = data?.updatePersonalGanttTask
//         if (!updatedTask) return

//         // Identify the specific task fragment in the cache
...
//         // Use cache.modify for a surgical update.
//         // This is safer than read/writeQuery as it avoids race conditions.
//         cache.modify({
//           id: cacheId,
//           fields: {
...
//             // By OMITTING `displayOrder` here, we tell Apollo Client to
//             // NOT update it from the mutation response, thus preserving the
//             // existing value that is already in the cache.
//           },
//         })
//       },
//     })
