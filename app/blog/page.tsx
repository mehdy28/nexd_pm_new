      ...
      <div className="container mx-auto px-4 pt-40 pb-24">
        <div className="max-w-7xl mx-auto">
            ...
            <main className="lg:col-span-6">
              {featuredPost && (
                <Link href={`/blog/${featuredPost.slug}`} className="group block">
                  <Card className="overflow-hidden bg-white/60 backdrop-blur-xl border border-slate-200/80 hover:shadow-2xl hover:border-teal-300 transition-all duration-300 shadow-lg shadow-teal-500/10">
          ...
          {additionalPosts.length > 0 && (
            <div className="mt-16">
              <h2 className="text-3xl font-bold text-slate-900 mb-8 border-t border-slate-200 pt-12">
                Latest Articles
              </h2>
