                ...
                <Card className="bg-gradient-to-r from-blue-50 to-blue-50 border-blue-200">
                  <CardContent className="p-8 text-center">
                    ...
                    <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                      Get the latest insights on AI-powered project management,
                      visual prompt engineering, and the future of work
                      ...
                      <div className="flex gap-3 p-3 rounded-lg hover:bg-white transition-colors">
                        <div className="w-16 h-16 relative overflow-hidden rounded-lg flex-shrink-0">
                          <Image
                            src={
                              post.image ||
                              `/placeholder.svg?height=64&width=64&query=AI illustration ${
                                index + 1
                              }`
                            }
                            alt={post.title}
                    ...
                    <Card className="overflow-hidden hover:shadow-md transition-shadow duration-300 border-0 shadow-sm h-full">
                      <div className="aspect-[4/3] relative overflow-hidden">
                        <Image
                          src={
                            post.image ||
                            "/placeholder.svg?height=200&width=300&query=AI project management"
                          }
                          alt={post.title}
                          fill
                          className="object-cover group-hover:scale-105 transition-transform duration-300"
