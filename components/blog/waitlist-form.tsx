...
export function WaitlistForm({ variant = "full" }: WaitlistFormProps) {
    ...
    return (
      <Card className="bg-slate-50 border-slate-200 rounded-2xl">
        <CardContent className="p-6">
          ...
          {isSubmitted ? (
            <div className="text-center">
              <p className="text-teal-800 font-medium text-sm">🎉 You're in!</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              <Input
                ...
                required
                disabled={mutationLoading}
                className="text-sm rounded-full border-2 border-slate-300 focus:border-teal-500 h-10 px-4"
              />
              <Input
                type="email"
  ...
  if (variant === "inline") {
    return (
      <div className="bg-gradient-to-r from-teal-50/50 to-cyan-50/50 rounded-2xl p-6 border border-slate-200">
          ...
          <form onSubmit={handleSubmit} className="max-w-md mx-auto">
            <div className="flex flex-col sm:flex-row gap-3 mb-4">
              <Input
                ...
                required
                disabled={mutationLoading}
                className="flex-1 rounded-full h-12 px-5 border-2 border-slate-300 focus:border-teal-500"
              />
              <Input
                type="email"
