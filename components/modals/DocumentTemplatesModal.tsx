...
import { templates, Template, templateCategories } from "@/lib/documents/document-templates"
      ...
      <DialogContent className="flex h-[90vh] max-w-6xl flex-col bg-white">
                    ...
                    {templatesInCategory.map(template => (
                      <div key={template.name} className="flex flex-col gap-6 sm:flex-row">
                        <div className="w-full sm:w-1/2">
                          <div className="aspect-video overflow-hidden rounded-md border bg-white p-4">
                            <img
        ...
        {isCreating && (
          <div className="absolute inset-0 z-20 flex items-center justify-center rounded-lg bg-white/80 backdrop-blur-sm">
            ...
            <span className="ml-3 text-lg font-medium">Creating document...</span>
          </div>
        )}
      </DialogContent>
    </Dialog>
