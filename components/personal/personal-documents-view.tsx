...
export function PersonalDocumentsView() {
  ...
  const handleCreateDoc = useCallback(
    () => createPersonalDocument("Untitled Document"),
    [createPersonalDocument]
  )
  ...
  const confirmDelete = useCallback(async () => {
    ...
    try {
      await deletePersonalDocument(deleteTarget)
    } catch (err) {
          ...
          <div className="flex h-full min-h-0 flex-col gap-1">
            <div className="flex items-center gap-2">
              ...
              <Input
                ...
                onChange={e => updatePersonalDocument(selectedDocument.id, { title: e.target.value })}
                          ...
                          <div className="flex items-start gap-2">
                            ...
                            {isEditing ? (
                              <Input
                                ...
                                className="h-8"
                                onBlur={e => {
                                  updatePersonalDocument(doc.id, { title: e.target.value.trim() })
                                  setEditingId(null)
                                }}
                                onKeyDown={e => {
