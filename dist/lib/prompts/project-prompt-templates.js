...
export const projectTemplates = [
    // --- Category: Reporting ---
    {
        ...
        variables: [
            ...
            { name: "Overdue Tasks", placeholder: "{{OVERDUE_TASKS}}", type: PromptVariableType.LIST_OF_STRINGS, source: { entityType: "TASK", aggregation: AggregationType.LIST_FIELD_VALUES, aggregationField: "title", format: FormatType.BULLET_POINTS, filters: [{ field: "endDate", operator: FilterOperator.LT, specialValue: "TODAY" }, { field: "status", operator: FilterOperator.NEQ, value: "DONE" }] } },
        ],
    },
    {
    ...
    },
    {
        ...
        variables: [
            ...
            { name: "My Overdue Tasks", placeholder: "{{MY_OVERDUE_TASKS}}", type: PromptVariableType.LIST_OF_STRINGS, source: { entityType: "TASK", aggregation: AggregationType.LIST_FIELD_VALUES, aggregationField: "title", format: FormatType.BULLET_POINTS, filters: [{ field: "assigneeId", operator: FilterOperator.EQ, specialValue: "CURRENT_USER" }, { field: "endDate", operator: FilterOperator.LT, specialValue: "TODAY" }, { field: "status", operator: FilterOperator.NEQ, value: "DONE" }] } },
        ],
    },
    {
    ...
    // --- Category: Analysis ---
    {
        ...
        variables: [
            ...
            { name: "Overdue Task Count", placeholder: "{{OVERDUE_COUNT}}", type: PromptVariableType.NUMBER, source: { entityType: "TASK", aggregation: AggregationType.COUNT, filters: [{ field: "endDate", operator: FilterOperator.LT, specialValue: "TODAY" }, { field: "status", operator: FilterOperator.NEQ, value: "DONE" }] } },
            { name: "Overdue Tasks", placeholder: "{{OVERDUE_TASKS}}", type: PromptVariableType.LIST_OF_STRINGS, source: { entityType: "TASK", aggregation: AggregationType.LIST_FIELD_VALUES, aggregationField: "title", format: FormatType.BULLET_POINTS, filters: [{ field: "endDate", operator: FilterOperator.LT, specialValue: "TODAY" }, { field: "status", operator: FilterOperator.NEQ, value: "DONE" }] } },
        ],
    },
    {
