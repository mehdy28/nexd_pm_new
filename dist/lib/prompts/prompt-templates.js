import { PromptVariableType } from "@/components/prompt-lab/store";
export const templates = [
    // 1. Prioritization and Focus
    {
        name: "Define 3 Key Personal Objectives (OKR Style)",
        category: "Productivity",
        description: "Establish clear, measurable objectives for the next period, focusing on professional growth or personal development, independent of any current project mandate.",
    ...
    // 3. Time Management and Blocking Analysis
    {
        ...
        category: "Productivity",
        description: "Analyze a typical work week to pinpoint non-essential tasks or major distractions, and suggest concrete strategies for blocking and focused work.",
    ...
    // 4. Learning Path/Skill Development
    {
        ...
        description: "Generate a step-by-step roadmap for acquiring a new, non-project specific professional skill, including resources and milestones.",
        modelProfileId: "gpt-4o",
        content: [
            {
                type: "text",
    ...
    // 5. General Communication Prep
    {
        ...
        category: "Business",
        description: "Prepare talking points and a structured outline for a sensitive or challenging non-project related discussion (e.g., asking for a raise, giving negative feedback, discussing boundaries).",
        modelProfileId: "gpt-4o",
        content: [
            {
                type: "text",
    ...
    // 6. Problem Solving / Root Cause Analysis (Personal/Process)
    {
        ...
        category: "Productivity",
        description: "Apply the 5 Whys technique to identify the non-technical, human-error, or process-related root cause of a recurring professional setback or failure.",
        modelProfileId: "gpt-4o-mini",
        content: [
            {
                type: "text",
    ...
    // 7. Reframing Negative Feedback
    {
        ...
        category: "Productivity",
        description: "Take vague or critical professional feedback and transform it into three clear, positive, and measurable development goals.",
        modelProfileId: "gpt-4o-mini",
        content: [
            {
                type: "text",
    ...
    // 8. Content Repurposing (General thought leadership)
    {
        ...
        category: "Marketing",
        description: "Generate topics and titles for personal professional content (blog, presentation, talk) based on expertise, aiming to establish user authority.",
        modelProfileId: "gpt-4o",
        content: [
            {
                type: "text",
    ...
    // 9. Simplified Technical Explanation
    {
        ...
        category: "Development",
        description: "Condense dense technical or theoretical documentation into a high-level summary suitable for non-technical leadership or non-specialists.",
        modelProfileId: "gpt-4o-mini",
        content: [
            {
                type: "text",
    ...
    // 10. General Brainstorming / Idea Expansion
    {
        ...
        category: "Productivity",
        description: "Use brainstorming techniques (like SCAMPER) to break through a general professional or creative block by forcing alternative perspectives.",
        modelProfileId: "gpt-4o",
        content: [
            {
                type: "text",
