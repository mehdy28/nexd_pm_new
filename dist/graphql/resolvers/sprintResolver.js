...
import { SprintStatus } from "../../types/sprint.js"; // Ensure this is present in your file
...
export const sprintResolvers = {
    Mutation: {
        createSprint: async (_parent, { input, }) => {
        ...
        updateSprint: async (_parent, { input, }) => {
